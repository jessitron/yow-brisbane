...
var _user$project$Main$drawLabels = function (labels) {
	var formatLabel = function (_p0) {
		var _p1 = _p0;
		return A2(
	...
	return A2(
		...
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, formatLabel, labels));
};
var _user$project$Main$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	{
		labels: {ctor: '[]'},
		newLabel: '',
		lastClick: _elm_lang$core$Maybe$Nothing
	},
	{ctor: '[]'});
var _user$project$Main$diagram = 'elmprogram.png';
var _user$project$Main$Model = F3(
	function (a, b, c) {
		return {labels: a, newLabel: b, lastClick: c};
	});
var _user$project$Main$Label = F3(
	function (a, b, c) {
		return {text: a, x: b, y: c};
	});
var _user$project$Main$FocusFieldNotFound = function (a) {
	return {ctor: 'FocusFieldNotFound', _0: a};
};
...
var _user$project$Main$SaveLabel = function (a) {
	return {ctor: 'SaveLabel', _0: a};
};
var _user$project$Main$NewLabel = function (a) {
	return {ctor: 'NewLabel', _0: a};
};
...
var _user$project$Main$newLabelInput = function (model) {
	var _p2 = model.lastClick;
	if (_p2.ctor === 'Nothing') {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('newLabel'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$NewLabel),
					_1: {
						ctor: '::',
						_0: _user$project$Main$onEnter(
							_user$project$Main$SaveLabel(
								{text: model.newLabel, x: _p3, y: _p4})),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$value(model.newLabel),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$style(
									{
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_0: {
								...
								_1: A2(
									_elm_lang$core$Basics_ops['++'],
									'url(',
									A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$diagram, ')'))
							},
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$drawLabels(model.labels),
				_1: {
					ctor: '::',
					_0: _user$project$Main$newLabelInput(model),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Main$requestFocus = function (field_id) {
	var handle = function (result) {
		var _p5 = result;
		if (_p5.ctor === 'Ok') {
			return _user$project$Main$Noop;
		} else {
			return _user$project$Main$FocusFieldNotFound(_p5._0._0);
		}
	};
	return A2(
		_elm_lang$core$Task$attempt,
		handle,
		_elm_lang$dom$Dom$focus(field_id));
};
			...
			case 'SaveLabel':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							labels: {ctor: '::', _0: _p6._0, _1: model.labels},
							newLabel: '',
							lastClick: _elm_lang$core$Maybe$Nothing
						}),
					{ctor: '[]'});
			case 'Click':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							lastClick: _elm_lang$core$Maybe$Just(_p6._0)
						}),
					{
						ctor: '::',
						_0: _user$project$Main$requestFocus('newLabel'),
						_1: {ctor: '[]'}
					});
			default:
				return A2(
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"SaveLabel":["Main.Label"],"FocusFieldNotFound":["String"],"NewLabel":["String"],"Noop":[],"Click":["Mouse.Position"]}}},"aliases":{"Mouse.Position":{"args":[],"type":"{ x : Int, y : Int }"},"Main.Label":{"args":[],"type":"{ text : String, x : Int, y : Int }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
